...
import {
  FaBars, FaChartPie, FaArrowCircleUp, FaMoneyBillWave,
  FaExchangeAlt, FaClipboardList, FaWallet,
  FaTags, FaCog, FaSignOutAlt
} from "react-icons/fa";
...
export const Sidebar = () => {
  ...
  return (
    <>
      ...
      <aside
        className={`
          h-screen z-50 flex flex-col justify-between
          transition-all duration-300
          bg-sidebar text-sidebar-foreground border-r border-sidebar-border
          ${collapsed ? 'w-16' : 'w-64'}
          ${collapsed ? 'sm:relative' : 'fixed sm:relative'}
          top-0 left-0
        `}
      >
        <div>
          ...
          <div className="flex items-center justify-between p-4 border-b border-sidebar-border">
            ...
            <button
              ...
              className="hidden sm:block text-sidebar-foreground hover:text-sidebar-primary"
            >
              <FaBars />
            </button>
          </div>
