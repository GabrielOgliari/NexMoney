...
module.exports = (sequelize, DataTypes) => {
  class investimentsVariableIncomeExit extends Model {
    static associate(models) {
      // associações se necessário
    }
  }
  investimentsVariableIncomeExit.init(
    {
    ...
    {
      sequelize,
      modelName: "investimentsVariableIncomeExit",
      tableName: "investiments_variable_income_exit",
    }
  );
  return investimentsVariableIncomeExit;
};
